...
package GamePlay.Level1
{
	...
	public class VerticalWall extends GameObject
	{
		...
		*/
		/*******************************************************************************/
		public function VerticalWall(nPosX_:Number, nPosY_:Number):void
		{
			super(new wallvertical(), nPosX_, nPosY_, GamePlayGlobals.GO_WALL);
			nInitialPosX = nPosX_;
			nInitialPosY = nPosY_;
		}
		...
		*/
		...
		override public function Initialize():void
		{
			...
			polygonshape.SetAsBox(10/iMeterToPixelsRatio , 260/iMeterToPixelsRatio);
