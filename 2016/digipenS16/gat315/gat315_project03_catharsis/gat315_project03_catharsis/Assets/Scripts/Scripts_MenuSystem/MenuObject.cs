...
public class MenuObject : MonoBehaviour
{
    ...
    public UIAnimations UIAnimation;
    ...
    void Start()
    {
        ...
        this.SFX = GameObject.FindWithTag("SFX").gameObject.GetComponent<SoundManager>();
    ...
    public void OnActivate()
    {
        ...
        //play sfx
        this.SFX.PlayPaitiently(this.ButtonSFX[0]);
    }
    ...
    public void OnSelected()
    {
        ...
        //play sfx
        this.SFX.PlaySingle(this.ButtonSFX[1]);
    }
