...
public class SpikeTrap : MonoBehaviour
{
    ...
    public float deployOffset = 0.3f;
    ...
    void DeployTrap()
    {
        ...
        {
            LeanTween.moveLocalY(spike, deployOffset, deployTime).setEase(acDeploy);
    ...
    void ResetTrap()
    {
        ...
        foreach (GameObject spike in spikes)
        {
            LeanTween.moveLocalY(spike, -deployOffset, resetTime).setEase(acReset).setDelay(resetDelay);
