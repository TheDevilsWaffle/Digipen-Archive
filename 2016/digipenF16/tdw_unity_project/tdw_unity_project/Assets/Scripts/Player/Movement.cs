...
public class Movement : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Events.instance.AddListener<EVENT_Round_Start>(EnableMovement);
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>
    /// Start()
    ...
    void FixedUpdate()
    {
        if (movementEnabled)
        {
            ...
            if (this.gameObject != null && playerNumber < GamePadInput.players.Count)
            {
                //get ground status
    ...
    #region METHODS
    void EnableMovement(EVENT_Round_Start _event)
    {
    ...
    void OnDestroy()
    {
        Events.instance.RemoveListener<EVENT_Round_Start>(EnableMovement);
    }
