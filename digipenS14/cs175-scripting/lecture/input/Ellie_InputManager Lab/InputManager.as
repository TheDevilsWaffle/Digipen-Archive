...
package
{
	...
	final public class InputManager
	{
		...
		*/
		/*******************************************************************************/
		static public function Initialize(sStage_:Stage):void
		{
			sStage = sStage_;
		...
		*/
		...
		{
			return (vKeyPressed[keyCode_] == true && vKeyWasPressed[keyCode_] == false);
		}
		...
		*/
		...
		{
			return (vKeyPressed[keyCode_] == false && vKeyWasPressed[keyCode_] == true);
		}
	}
}
